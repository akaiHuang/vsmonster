...
| `packages/gateway/src/server.ts` | 👾 原創 | Gateway 服務器 |
| `packages/gateway/src/task/` | 👾 原創 | 任務管理 |
| `packages/gateway/src/copilot/` | 👾 原創 | Copilot 橋接 (Gateway 端) |
| `packages/gateway/src/mcp/` | 👾 原創 | MCP 控制器 |
| `packages/gateway/src/tunnel/` | 👾 原創 | ngrok 隧道 |
| `packages/gateway/src/setup/` | 👾 原創 | 設定向導 |
| `packages/gateway/src/channels/` | 🔀 混合 | 頻道抽象層 (使用 Moltbot 但有原創抽象) |
| `packages/vscode-extension/` | 👾 原創 | 完全原創 |
| `packages/shared/` | 👾 原創 | 類型定義 |
| `configs/` | 👾 原創 | 配置格式 |
| `docs/` | 👾 原創 | 文件 |
| `scripts/` | 👾 原創 | 腳本 |
