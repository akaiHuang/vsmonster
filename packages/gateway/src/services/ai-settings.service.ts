...
export const AVAILABLE_MODELS = [
  ...
  { id: 'gemini-3-flash', label: 'Gemini 3 Flash (Preview)', provider: 'Google', multiplier: '0.33x' },
  { id: 'gemini-3-pro', label: 'Gemini 3 Pro (Preview)', provider: 'Google', multiplier: '1x' },
